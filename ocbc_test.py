...
def test_process():
    ...
    assert rows[6] == ('31/10/2016', '', 'Eating out', "-1393 MCDONALD'S (CCP)   SINGAPORE    SG", '8.00', '')
    assert rows[7] == ('30/10/2016', '', 'Groceries', '-1393 COLD STORAGE EASTWOSINGAPORE    SG', '79.15', '')
    assert rows[8] == ('29/10/2016', '', 'Groceries', '-1393 COLD STORAGE EASTWOSINGAPORE    SG', '10.10', '')
    assert rows[9] == ('29/10/2016', '', 'Groceries', '-1393 COLD STORAGE EASTWOSINGAPORE    SG', '14.20', '')
